...
int main(int argc, char *argv[])
{
    ...
    QObject::connect(
        ...
        &QGameStateModel::
            playerTurnDone,     // pointer to a member function - the signal
    ...
    QObject::connect(
        ...
        &QGameAI_Thread::
            aiMoveChosen,         // pointer to a member function - the signal
        &gameStateModel,          // hook it up to the listener - the receiver
        &QGameStateModel::
            insertTokenIntoColumn // pointer to a member function - the slot
    );
    ...
    return app
        .exec(); // start event loop of QApplication to notify all its QObjects about events
}
