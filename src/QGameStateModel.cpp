...
QGameStateModel::QGameStateModel(Player playerYou, int ncols, int nrows, QObject *parent)
	:
	QAbstractTableModel(parent),
...
QVariant QGameStateModel::headerData(int section, Qt::Orientation orientation, int role) const {
...
bool QGameStateModel::setData(const QModelIndex & index, const QVariant & value, int role) {
	if (!index.isValid()) {
		return false;
	}
...
bool QGameStateModel::insertRows(int position, int rows, const QModelIndex & index) {
	return false;
}

bool QGameStateModel::removeRows(int position, int rows, const QModelIndex & index) {
	return false;
}

bool QGameStateModel::insertColumns(int position, int columns, const QModelIndex & parent) {
	return false;
}

bool QGameStateModel::removeColumns(int position, int columns, const QModelIndex & parent) {
	return false;
}
